...
from keep_alive import app  # Faqat Flask app kerak
import telebot
...
from keep_alive import keep_alive  # TO‘G‘RI IMPORT QILINDI

print("Bot ishga tushdi...")
keep_alive()
bot.polling(none_stop=True)
from keep_alive import keep_alive  # 👈 BIRINCHI QATORDA BO‘LSIN

print("Bot ishga tushdi...")
keep_alive()
bot.polling(none_stop=True)
from keep_alive import keep_alive  # bu yuqorida bo'lishi kerak
